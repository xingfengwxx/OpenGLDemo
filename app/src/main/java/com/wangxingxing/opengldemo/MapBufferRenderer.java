...
public class MapBufferRenderer implements GLSurfaceView.Renderer {
    ...
    private static final String TAG = "MapBufferRenderer";
    ...
    public void onSurfaceCreated(GL10 gl, EGLConfig config) {
        ...
        //编译
        final int vertexShaderId = ShaderUtils.compileVertexShader(OpenUtils.readRawTextFile(App.instance,R.raw.vertex_map_buffer_shader));
        final int fragmentShaderId = ShaderUtils.compileFragmentShader(OpenUtils.readRawTextFile(App.instance,R.raw.fragment_map_buffer_shader));
        //鏈接程序片段
        ...
        //3. 映射缓冲区对象
        ByteBuffer buffer = (ByteBuffer) GLES30.glMapBufferRange(GLES30.GL_ARRAY_BUFFER, 0,
